...
import { _contactDeleteAction } from "@/_api/_actions/ContactActions"
...
const BreadCrumbsData = [
    ...
    {id: 3, name: "Message List", href:"/admin/message"},
]
...
export default function MessageListSection() {
  ...
  async function handleDelete(id: string | number){
      try{
          const res = await _contactDeleteAction(id) 
              ...
              <section className="hidden md:block w-full overflow-x-auto rounded-lg border border-gray-400">
                <div className='min-w-[700px]'>
                  ...
                  <section className="bg-gray-300 font-bold text-sm lg:text-base flex items-center">
                    ...
                    <div className="w-[20%] border-r border-gray-400 px-2 py-2">DATE</div>
