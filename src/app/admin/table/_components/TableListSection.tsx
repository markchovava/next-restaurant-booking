...
import { _tableFloorPlanDeleteAction, _tableFloorPlanStoreAllAction } from "@/_api/_actions/TableFloorPlanActions"
...
export default function TableListSection() {
  ...
  /* async function handleDelete(id: string | number | null){
      try{
          const res = await _tableFloorPlanDeleteAction(id) 
  ...
  /* const addData = async () => {
    ...
    try {
        ...
        if (res.status === 1) {
            ...
            const errorMessage = res.message || res.error || 'Failed to save data';
              ...
              <section className="hidden md:block w-full overflow-x-auto rounded-lg border border-gray-400">
                <div className='min-w-[700px]'>
                  ...
                  <section className="bg-gray-300 font-bold text-sm lg:text-base flex items-center">
                    ...
                    <div className="w-[30%] border-r border-gray-400 px-2 py-2">FLOOR</div>
                    <div className="w-[20%] border-r border-gray-400 px-2 py-2">LAST UPDATED</div>
                  ...
                  <div key={key} className="bg-white border border-gray-300 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
                    <div className="space-y-2">
                      ...
                      <div className="pt-2 border-t border-gray-200">
                        <p className="text-xs text-gray-500 font-medium mb-1">FLOOR</p>
